...
from .errors import BuzzFileIOError
from buzzref import constants, widgets
...
class ExporterBase:
    ...
    def handle_export_error(self, filename, error, worker):
        ...
        if worker:
            ...
            raise BuzzFileIOError(msg=str(error), filename=filename) from e
...
class ImagesToDirectoryExporter(ExporterBase):
    ...
    def __init__(self, scene, dirname):
        ...
        self.items = list(self.scene.items_by_type(BuzzPixmapItem.TYPE))
        self.max_save_id = 0
