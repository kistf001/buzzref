...
from buzzref.widgets.controls.keyboard import KeyboardShortcutsView
from buzzref.widgets.controls.mouse import MouseView
from buzzref.widgets.controls.mousewheel import MouseWheelView
